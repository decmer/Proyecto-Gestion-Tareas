 ...
 * @author jose
 */
public class JDialogManaProyectos extends javax.swing.JDialog {

    /**
     * Creates new form JDialogUsuarios
     */
    private JDialogModifiTarea main;
    private DefaultTableModel mU = new DefaultTableModel(null, new String[]{"ID","NOMBRE", "DESCRIPCION", "F_LIMITE"});
    private Managers mana;

    
    public JDialogManaProyectos(java.awt.Frame parent, boolean modal, JDialogModifiTarea mod) {
        super(parent, modal);
        initComponents();
        this.main = mod;
        mana = (Managers)((JFrame)parent).usu;
        jTable1.setModel(mU);
        ...
        while(oS.hasNext()){
            ...
            if (p.getManager().getId() == mana.getId()) {
                mU.addRow(new String[]{p.getId()+"", p.getNombre(), p.getDesccripcion(), p.getFechaLimite().toString()});
            }
        }
    }
    ...
    private void EnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnviarActionPerformed
        ...
        if(row>=0){
            main.jTextFieldIdProyecto.setText(jTable1.getValueAt(row, 0)+"");
        }
        dispose();
