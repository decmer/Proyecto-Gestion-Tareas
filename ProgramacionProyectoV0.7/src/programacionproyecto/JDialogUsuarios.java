...
public class JDialogUsuarios extends javax.swing.JDialog {
     ...
     */
    public JFrame main;
    public DefaultTableModel mU = new DefaultTableModel(null, new String[]{"ID","NOMBRE", "PUESTO"});
    ...
    public JDialogUsuarios(java.awt.Frame parent, boolean modal) {
        ...
        while(oS.hasNext()){
            Usuarios u = (Usuarios)oS.next();
            mU.addRow(new String[]{u.getId()+"", u.getNombre(), Usuarios.tipoUsuario(u)});
        }
    }
    ...
    private void EnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnviarActionPerformed
        ...
        if(row>=0){
            main.jTextFieldInicioID.setText(jTable1.getValueAt(row, 0)+"");
        }
        dispose();
